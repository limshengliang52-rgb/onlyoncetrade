...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/api/public/check' | '/api/public/payments/webhook'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/api/public/check' | '/api/public/payments/webhook'
  id: '__root__' | '/' | '/api/public/check' | '/api/public/payments/webhook'
