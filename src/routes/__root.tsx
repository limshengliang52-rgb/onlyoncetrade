  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">请稍后再试或返回首页。</p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "OnlyOnce EA Trade · MT5 EA 工具授权服务" },
      {
        name: "description",
        content:
          "OnlyOnce EA Trade 提供 MT5 EA 工具授权、UID 开通说明与订阅管理。交易存在风险，本服务不构成投资建议。",
      },
      { name: "author", content: "OnlyOnce EA Trade" },
      { property: "og:title", content: "OnlyOnce EA Trade · MT5 EA 工具授权服务" },
      {
        property: "og:description",
        content: "OnlyOnce EA Trade 提供 MT5 EA 工具授权、UID 开通说明与订阅管理。交易存在风险，本服务不构成投资建议。",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@400;500;600;700&family=DM+Sans:wght@400;500;600;700&family=Noto+Sans+SC:wght@400;500;700&display=swap",
      },
    ],
  }),
